...
void main()
{
      ...
      for(time = process_queue[0].arrival_time; time < burst_time;)
      {
            ...
            printf("\n%d\t\t%d\t\t%d\t\t%d\t\t%d\t\t%d", process_queue[largest].process_name, process_queue[largest].arrival_time, process_queue[largest].burst_time, process_queue[largest].priority, process_queue[largest].waiting_time, process_queue[largest].waiting_time+process_queue[largest].burst_time);
      }
